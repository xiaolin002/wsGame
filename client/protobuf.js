...
/**
 * Constructs a new web method instance.
 * @classdesc Reflected web method.
 * @extends ReflectionObject
 * @constructor
...
/**
 * Looks up the {@link Service|web} at the specified path, relative to this namespace.
 * Besides its signature, this methods differs from {@link Namespace#lookup|lookup} in that it throws instead of returning `null`.
 * @param {string|string[]} path Path to look up
 * @returns {Service} Looked up web
 * @throws {Error} If `path` does not point to a web
 */
...
/**
 * RPC implementation passed to {@link Service#create} performing a web request on network level, i.e. by utilizing http requests or websockets.
 * @typedef RPCImpl
 * @type {function}
...
/**
 * A web method callback as used by {@link rpc.ServiceMethod|ServiceMethod}.
 *
 * Differs from {@link RPCImplCallback} in that it is an actual callback of a web method which may not return `response = null`.
...
/**
 * A web method part of a {@link rpc.Service} as created by {@link Service.create}.
...
/**
 * Constructs a new RPC web instance.
 * @classdesc An RPC web as returned by {@link Service#create}.
 * @exports rpc.Service
...
function Service(rpcImpl, requestDelimited, responseDelimited) {
    ...
    /**
     * RPC implementation. Becomes `null` once the web is ended.
     * @type {RPCImpl|null}
     */
...
/**
 * Calls a web method through {@link rpc.Service#rpcImpl|rpcImpl}.
...
/**
 * Ends this web and emits the `end` event.
 * @param {boolean} [endedByRPC=false] Whether the web has been ended by the RPC implementation.
...
/**
 * Constructs a web from a web descriptor.
 * @param {string} name Service name
 * @param {IService} json Service descriptor
 * @returns {Service} Created web
 * @throws {TypeError} If arguments are invalid
 */
...
/**
 * Converts this web to a web descriptor.
 * @param {IToJSONOptions} [toJSONOptions] JSON conversion options
...
/**
 * Methods of this web as an array for iteration.
...
/**
 * Creates a runtime web using the specified rpc implementation.
 * @param {RPCImpl} rpcImpl RPC implementation
 * @param {boolean} [requestDelimited=false] Whether requests are length-delimited
 * @param {boolean} [responseDelimited=false] Whether responses are length-delimited
 * @returns {rpc.Service} RPC web. Useful where requests and/or responses are streamed.
 */
